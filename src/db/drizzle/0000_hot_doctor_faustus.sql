...
--> statement-breakpoint
CREATE INDEX `catalog_product_images_product_id_idx` ON `catalog_product_images` (`product_id`);--> statement-breakpoint
...
CREATE INDEX `catalog_products_category_id_idx` ON `catalog_products` (`category_id`);--> statement-breakpoint
CREATE INDEX `catalog_products_price_cents_idx` ON `catalog_products` (`price_cents`);--> statement-breakpoint
CREATE INDEX `catalog_products_created_at_idx` ON `catalog_products` (`created_at`);--> statement-breakpoint
CREATE INDEX `catalog_products_homepage_category_idx` ON `catalog_products` (`category_id`,`show_on_homepage`);--> statement-breakpoint
